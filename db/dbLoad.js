...
const models = require("../modelDatas/model.js");
...
async function dbLoad() {
  ...
  for (const user of userModels) {
    const login_name = `${user.first_name.toLowerCase()}_${user.last_name.toLowerCase()}`;
    ...
    try {
      ...
      console.log(
        ...
        "with login_name:", login_name,
        "password:", defaultPassword,
        "and ID:", user.objectID,
      );
    } catch (error) {
